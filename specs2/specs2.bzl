...
def specs2_repositories():
  ...
  native.maven_jar(
      ...
      artifact = "org.scalaz:scalaz-effect_2.11:7.2.0",
  ...
  native.maven_jar(
      ...
      artifact = "org.scalaz:scalaz-core_2.11:7.2.0",
  ...
  native.maven_jar(
    name = "io_bazel_rules_scala_org_scalaz_scalaz_concurrent",
    artifact = "org.scalaz:scalaz-concurrent_2.11:7.2.0"
  )
  native.bind(name = 'io_bazel_rules_scala/dependency/scalaz/scalaz_concurrent', actual = '@io_bazel_rules_scala_org_scalaz_scalaz_concurrent//jar')

  native.maven_jar(
    name = "io_bazel_rules_scala_org_scalaz_stream_scalaz_stream",
    artifact = "org.scalaz.stream:scalaz-stream_2.11:0.8",
  )
  native.bind(name = 'io_bazel_rules_scala/dependency/scalaz/scalaz_stream', actual = '@io_bazel_rules_scala_org_scalaz_stream_scalaz_stream//jar')
...
def specs2_dependencies():
  ...
  "//external:io_bazel_rules_scala/dependency/scalaz/scalaz_concurrent",
  "//external:io_bazel_rules_scala/dependency/scalaz/scalaz_stream",
